...
function position_loader() {
    ...
    var top_loader = document.documentElement.clientHeight / 2 - 200;
    var left_loader = document.documentElement.clientWidth / 2 - 200;
    loader.style.top = top_loader + 'px';
    loader.style.left = left_loader + 'px';
    loader.style.display = "block";
}

//function for download and displayed list of pokedex
            ...
            for (var key in objects) {
                ...
                if(i == 12)
                    ...
                    <div id="load_more" class="col-md-12">\
                        <button type="button" class="btn btn-load_more btn-primary" onclick="this.remove();loadPokedex(\'http://pokeapi.co' + object_result.meta.next + '\');">Load More</button>\
                    </div></div>';
                i++;
            }
...
//function for download and displayed single pokemon
